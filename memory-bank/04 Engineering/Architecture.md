...
6. Initial extraction modules live in `the-getaway/src/game/scenes/main/modules/`:
   ...
   - `CameraModule.ts` (camera follow/bounds/zoom/resize orchestration plus immediate player-follow viewport broadcasts)
