...
- After completing any roadmap step, record it in [[04 Engineering/Roadmap]] with matching step metadata before continuing.
...
- **Phase:** Phase 1: Project Setup and Core Infrastructure
...
- **Phase:** Phase 2: Core Game Mechanics
...
- **Phase:** Phase 3: Exploration and World Interaction
...
- **Phase:** Phase 4: Command & City Systems
...
### Step 11.5: Implement Downtown/Slums Overhaul
- **Phase:** Phase 4: Command & City Systems
...
### Step 16.5: Author Storylet Library Framework
- **Phase:** Phase 5: Narrative and Quest Layer
...
### Step 16.6: Standardize Level → Mission → Quest Hierarchy & Resource Keys
- **Phase:** Phase 5: Narrative and Quest Layer
...
- Document the hierarchy and authoring workflow in [[04 Engineering/Architecture]], covering how to add new levels, missions, quests, NPCs, assets, and localization entries using the standardized keys.
...
### Step 16.7: Prototype Narrative → Triple → Scene Pipeline
- **Phase:** Phase 5: Narrative and Quest Layer
...
- Document the workflow in [[04 Engineering/Architecture]], covering how writers supply prompts, review triples, and integrate generated tilemaps.
...
### Step 16.8: Environmental Story Triggers & Ambient Feedback
- **Phase:** Phase 5: Narrative and Quest Layer
...
- Document the authoring workflow in [[04 Engineering/Architecture]], covering flag additions, trigger registration, and content authoring, and reference tone rules from [[03 Lore/Plot Bible]].
...
### Step 16.9: Route Ambient World Events Through George Assistant
- **Phase:** Phase 5: Narrative and Quest Layer
...
- Document the assistant-driven ambient workflow in [[04 Engineering/Architecture]] and note the HUD change in [[04 Engineering/Roadmap]].
...
### Step 16.10: Tone-Preserving Procedural Dialogue System
- **Phase:** Phase 5: Narrative and Quest Layer
...
- Review [[03 Lore/Plot Bible]] voice guidelines to align tone axes
...
- **Documentation**: Capture the system architecture in [[04 Engineering/Architecture]] and refresh [[01 MVP/Game Design]] with the narrative “voice” axis definitions and blending rules. Note tooling expectations in [[04 Engineering/Roadmap]] once implemented.
...
### Step 16.11: Hazard-to-System Integration Matrix
- **Phase:** Phase 5: Narrative and Quest Layer
...
- Document the matrix in [[01 MVP/Game Design]] (worldbuilding section) and summarize the data flow in [[04 Engineering/Architecture]], including guidance for adding new hazards.
...
### Step 16.12: Role-Based Procedural Dialogue Templates
- **Phase:** Phase 5: Narrative and Quest Layer
...
- Document authoring guidance in [[01 MVP/Game Design]] (narrative systems section) and log the new tooling in [[04 Engineering/Roadmap]] once implemented.
...
### Step 18.5: Centralize Depth Ordering and Camera PostFX Defaults
- **Phase:** Phase 6: Visual and Navigation Upgrades
...
- Author [[03 Lore/Art Direction]] that captures the depth rule, bias bands, camera FX order, and guidelines for introducing new FX or overlays. Link to this doc from [[04 Engineering/Architecture]] once implemented.
...
### Step 19.4: Stealth Mode Foundations (Engagement Model + Feedback)
- **Phase:** Phase 6: Visual and Navigation Upgrades
...
### Step 19.5: Surveillance Camera System (Curfew Enforcement)
- **Phase:** Phase 6: Visual and Navigation Upgrades
...
### Step 19.55: Adaptive NPC FSM Behaviors
- **Phase:** Phase 6: Visual and Navigation Upgrades
...
- **Configuration Surface**: Provide archetype configs in `src/content/ai/guardArchetypes.ts` where designers can tune base weights, modifiers, and cooldowns. Document authoring workflow in [[04 Engineering/Architecture]] when implemented.
...
### Step 19.8: Establish Atlas-Driven Noir Lighting Pipeline
- **Phase:** Phase 6: Visual and Navigation Upgrades
...
- Document asset naming (e.g., `district_propName_variant_v###.png`), normal-map conventions, and Light2D integration steps in [[04 Engineering/Architecture]], linking back to the painterly noir guidance in [[01 MVP/Game Design]].
...
### Step 20: Redesign Downtown Grid & Building Layout
- **Phase:** Phase 6: Visual and Navigation Upgrades
...
### Step 20.5: Streamable World Parcel Infrastructure
- **Phase:** Phase 6: Visual and Navigation Upgrades
...
- Document the streaming architecture and authoring expectations in [[04 Engineering/Architecture]], covering parcel sizing guidelines and performance targets.
...
### Step 22.1: Basic Character Creation Flow (UI Shell, Name, Visual Preset)
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 22.2: Attribute Allocation System
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 22.3: Background Selection with Starting Perks
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 23: Integrate Player Stats with Combat and Dialogue Systems
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 24.1: XP and Leveling Foundation
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 24.2: Skill Tree System with Combat Branch
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 24.3: Perk Selection System with Capstone Perks
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 24.5: Stamina System - Core Resource Pool (MVP)
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 24.6: Paranoia System — Player Fear Resource (MVP)
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 25: Expand Inventory System with Equipment and Durability
- **Phase:** Phase 7: Character Progression and Inventory
##### Inventory Data & Slot Framework
...
##### Durability & Encumbrance Mechanics
...
### Step 26: Advanced Combat Foundations
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 26.4: AutoBattle Mode & Tactical Automation
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 32.1: Implement Unit Test Suite (70%+ Code Coverage)
- **Phase:** Phase 10: Testing, Polish, and Release
...
### Step 35.2: Level Objective Progression Flow
- **Phase:** Phase 10: Testing, Polish, and Release
...
### Step 35.5: Implement George AI Assistant Overlay
- **Phase:** Phase 10: Testing, Polish, and Release
...
### Step 19.6: Implement Witness Memory & Regional Heat
- **Phase:** Phase 6: Visual and Navigation Upgrades
...
### Step 19.7: Street-Tension Director
- **Phase:** Phase 6: Visual and Navigation Upgrades
...
### Step 24.4: Rumor Cabinet Intel Perk Branch
- **Phase:** Phase 7: Character Progression and Inventory
...
- **Documentation**: Note the new perk branch and data flow in [[01 MVP/Game Design]] (Rumor systems) and [[04 Engineering/Architecture]] (perks-to-gossip integration) during implementation.
...
### Step 26.2: Overwatch Mode and Targeted Shots
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 26.3: Area-of-Effect Attacks and Combat Consumables
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 29.2: Establish Trust/Fear Ethics Layer
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 29.5: Implement Localized Witness Reputation Propagation
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 29.6: Gossip Heat Rumor Propagation
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 29.7: Dynamic District Uprisings & Resistance Simulation
- **Phase:** Phase 7: Character Progression and Inventory
...
- Document the director flow and authoring expectations in [[04 Engineering/Architecture]] (HOW) and note tonal guidelines for uprising messaging in [[03 Lore/Plot Bible]] (WHAT) during implementation.
...
### Step 29.8: Compile World-State Variable Atlas
- **Phase:** Phase 7: Character Progression and Inventory
...
- Extend [[01 MVP/Game Design]] with an XML-tagged appendix mirroring the atlas for designers, and update [[04 Engineering/Architecture]] to map each variable to its data flow, persistence requirements, and key listeners.
...
### Step 30.1: Basic Crafting System (Ammo and Medical Supplies)
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 30.2: Weapon Modification System
- **Phase:** Phase 7: Character Progression and Inventory
...
### Step 31.5: Seasonal Narrative Arc Episodes
- **Phase:** Phase 8: World Expansion
...
- Document the episode authoring workflow in [[04 Engineering/Architecture]] (director flow, save considerations) and record tone/style rules per episode type in [[03 Lore/Plot Bible]].
...
### Step 32.2: Create Integration Test Scenarios (E2E Testing)
- **Phase:** Phase 10: Testing, Polish, and Release
...
### Step 33: Expand Save Functionality
- **Phase:** Phase 10: Testing, Polish, and Release
...
### Step 34.7: Create In-Game Help System and External Documentation
- **Phase:** Phase 10: Testing, Polish, and Release
...
### Step 34.8: Implement WebGL Context Loss Recovery
- **Phase:** Phase 10: Testing, Polish, and Release
...
### Step 34.9: Document SpectorJS Profiling Workflow
- **Phase:** Phase 10: Testing, Polish, and Release
...
- Reference the guide from [[04 Engineering/Architecture]] under the rendering/diagnostics section so team members know where to find it.
...
### Step 35.7: Generate Narrative Ledger Epilogue
- **Phase:** Phase 10: Testing, Polish, and Release
...
- Author copy templates under `src/content/ledger/` that map ledger facts to tone-appropriate blurbs, citing references to [[03 Lore/Plot Bible]] for consistency. Provide localization IDs for each template.
...
- Document ledger data sources and authoring rules in [[01 MVP/Game Design]] (narrative systems appendix) and summarize the technical pipeline in [[04 Engineering/Architecture]]. Log completion in [[04 Engineering/Roadmap]].
...
### Step 26.1: Directional Cover and Flanking Mechanics
...
### Step 31: Build Industrial Wasteland Zone with Concrete Specifications
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
### Step 40.2: LLM-driven Narrative Orchestrator (PANGeA-style)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
- Draft designer rule packs ([[03 Lore/Plot Bible]], [[01 MVP/Game Design]]) into machine-readable “Game Rules” fed to the service (allowed topics, banned actions, tone, fail conditions).
...
- Document the workflow in [[04 Engineering/Architecture]] and add a companion `memory-bank/narrative-ai.md` outlining prompt schemas, validation stages, and operational safeguards.
...
### Step 40.5: Dynamic Black Market Economy & Smuggling Missions
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
- Update [[01 MVP/Game Design]] with economy formulas (WHAT) and [[04 Engineering/Architecture]] with data flow and director integration (HOW) when implemented.
...
### Step 26.4: Advanced Stamina - Day/Night, Fatigue & Environmental Systems
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
### Step 27.1: Vehicle Acquisition and Storage (Motorcycle Only, Basic Trunk)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
### Step 27.2: Vehicle Travel Movement (Fuel Consumption, 3x Movement Speed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
### Step 28.1: Hunger and Thirst Meters (Optional Survival Mode Toggle)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
4. Documented the new stealth model in [[01 MVP/Game Design]] and [[04 Engineering/Architecture]].

#### Implementation

-`the-getaway/src/components/GameController.tsx`-`the-getaway/src/components/ui/StealthIndicator.tsx`-`the-getaway/src/store/playerSlice.ts`-`the-getaway/src/store/worldSlice.ts`-`the-getaway/src/store/selectors/engagementSelectors.ts`-`the-getaway/src/game/systems/surveillance/cameraSystem.ts`-`the-getaway/src/game/systems/suspicion/observationBuilders.ts`-`memory-bank/01 MVP/Game Design.md`-`[[04 Engineering/Architecture]]`#### Validation
...
-`the-getaway/src/components/ui/GameMenu.tsx`introduces a local `activeView` state to swap between landing and settings layouts, adds a dedicated Settings button beside the primary CTAs, and compacts the settings panel with a bottom-return control plus the unified AutoBattle mode selector.
-`the-getaway/src/content/ui/index.ts`provides localisation entries for the new settings controls and guidance copy.
-`the-getaway/src/__tests__/GameMenu.test.tsx`verifies the landing focus and ensures the settings panel opens and closes as expected.
- Documentation update in`[[04 Engineering/Architecture]]`records the split-menu architecture for future HUD work.

- `the-getaway/src/components/ui/GameMenu.tsx`
- `the-getaway/src/content/ui/index.ts`
- `the-getaway/src/__tests__/GameMenu.test.tsx`
...
### Step 105: Simplify MiniMap HUD and restore full-size rendering (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** April 17, 2026
...
### Step 116: Apply 8-pt styling pass to MiniMap HUD module (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** May 9, 2026
...
-`the-getaway/src/components/ui/MiniMap.tsx`now computes wall bounds once per state update, translates/scales that crop so it occupies the full tactical lane, maps pointer coordinates back to the original grid, and exposes a dev-only overlay toggle (wired through `App.tsx` test mode) that draws the 8-pt grid and icon wrappers.
-`the-getaway/src/styles/hud-components.css`refits `.mini-map-panel`, `.mini-map-canvas`, and the new `.mini-map-dev-toggle` to the shared HUD tokens (spacing, radii, borders) so the panel matches the rest of the bottom dock.
-`the-getaway/src/App.tsx`passes the test-mode flag into `MiniMap`, letting QA flip the overlay without leaking the control into production sessions, and [[04 Engineering/Architecture]] records the cropping/overlay workflow.

- `the-getaway/src/components/ui/MiniMap.tsx`
- `the-getaway/src/styles/hud-components.css`
- `the-getaway/src/App.tsx`
- `[[04 Engineering/Architecture]]`
...
### Step 24.6: Paranoia System — Player Fear Resource (MVP) (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
-`the-getaway/src/store/paranoiaSlice.ts`encapsulates paranoia state, respite, decay boosts, cooldown ledger, and reducers; `paranoiaConfig.ts` contains tier thresholds and per-stimulus weights.
-`the-getaway/src/game/systems/paranoia/stimuli.ts`aggregates surveillance, pursuit, heat, hazard, and HP signals each frame, returning gain/loss breakdowns for `GameController` to dispatch.
-`the-getaway/src/components/GameController.tsx`evaluates stimuli, applies passive decay, adjusts guard perception multipliers, and listens for paranoia-tagged consumables;`the-getaway/src/components/ui/PlayerSummaryPanel.tsx`and`the-getaway/src/components/ui/GeorgeAssistant.tsx`surface the new HUD meter and Reassure action.
-`the-getaway/src/components/debug/ParanoiaInspector.tsx`offers live paranoia telemetry;`the-getaway/src/content/items/index.ts`introduces CalmTabs/Nicotine packs with matching tags;`the-getaway/src/game/combat/combatSystem.ts`applies tier-based hit penalties.

- `the-getaway/src/store/paranoiaSlice.ts`
- `the-getaway/src/game/systems/paranoia/stimuli.ts`
- `the-getaway/src/components/GameController.tsx`
- `the-getaway/src/components/ui/PlayerSummaryPanel.tsx`
- `the-getaway/src/components/ui/GeorgeAssistant.tsx`
- `the-getaway/src/components/debug/ParanoiaInspector.tsx`
- `the-getaway/src/content/items/index.ts`
- `the-getaway/src/store/__tests__/paranoiaSlice.test.ts`
...
### Step 93: Command Dock HUD consolidation (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** April 28, 2026
...
-`the-getaway/src/App.tsx`builds the bottom dock grid and manages expansion state while feeding renderer info to the debug panel.
-`the-getaway/src/components/ui/GeorgeAssistant.tsx`now renders the dock summary + expandable chat log without relying on the old marquee ticker.
-`the-getaway/src/components/debug/GameDebugInspector.tsx`merges renderer diagnostics with suspicion/paranoia telemetry behind a collapsible toggle.
-`the-getaway/src/components/GameCanvas.tsx`emits renderer metadata through an optional callback instead of an in-canvas overlay.

- `the-getaway/src/App.tsx`
- `the-getaway/src/components/ui/GeorgeAssistant.tsx`
- `the-getaway/src/components/debug/GameDebugInspector.tsx`
- `the-getaway/src/components/GameCanvas.tsx`
- `the-getaway/src/content/ui/index.ts`
- `[[04 Engineering/Architecture]]`
...
### Step 16.11: Hazard-to-System Integration Matrix (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
- `the-getaway/src/game/world/environment/environmentMatrix.ts`
- `the-getaway/src/game/world/environment/__tests__/environmentMatrix.test.ts`
- `the-getaway/src/store/selectors/worldSelectors.ts`
- `the-getaway/src/store/__tests__/worldSelectors.test.ts`
- `the-getaway/src/components/GameController.tsx`
- `the-getaway/src/components/ui/DayNightIndicator.tsx`
- `the-getaway/src/content/ui/index.ts`
...
### Step 16.12: Role-Based Procedural Dialogue Templates (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
- `the-getaway/src/game/narrative/dialogueTone/roleTemplateTypes.ts`
- `the-getaway/src/game/narrative/dialogueTone/templateResolver.ts`
- `the-getaway/src/game/narrative/dialogueTone/__tests__/templateResolver.test.ts`
- `the-getaway/src/content/dialogueTemplates/roles/index.ts`
- `the-getaway/src/content/dialogueTemplates/roles/merchant.ts`
- `the-getaway/src/content/dialogueTemplates/roles/checkpointGuard.ts`
- `the-getaway/src/content/dialogueTemplates/roles/streetDoc.ts`
- `the-getaway/src/content/dialogueTemplates/roles/gangScout.ts`
- `the-getaway/src/content/dialogueTemplates/roles/safehouseHandler.ts`
- `the-getaway/src/components/ui/DialogueOverlay.tsx`
- `memory-bank/01 MVP/Game Design.md`
- `[[04 Engineering/Architecture]]`
...
- `the-getaway/src/store/settingsSlice.ts`
- `the-getaway/src/store/autoBattleSlice.ts`
- `the-getaway/src/game/combat/automation/autoBattleProfiles.ts`
- `the-getaway/src/game/combat/automation/autoBattlePlanner.ts`
- `the-getaway/src/game/combat/automation/AutoBattleController.ts`
- `the-getaway/src/components/ui/CombatControlWidget.tsx`
- `the-getaway/src/components/GameController.tsx`
- `the-getaway/src/__tests__/autoBattlePlanner.test.ts`
- `the-getaway/src/content/ui/index.ts`
- `[[04 Engineering/Architecture]]`
- `memory-bank/01 MVP/Game Design.md`
...
### Step 16.10: Tone-Preserving Procedural Dialogue System (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
- `the-getaway/src/game/narrative/dialogueTone/toneTypes.ts`
- `the-getaway/src/game/narrative/dialogueTone/dialogueToneMixer.ts`
- `the-getaway/src/game/narrative/dialogueTone/dialogueToneManager.ts`
- `the-getaway/src/content/dialogueTone/index.ts`
- `the-getaway/src/content/dialogueTone/templates.ts`
- `the-getaway/src/content/dialogueTone/palettes.ts`
- `the-getaway/src/content/dialogueTone/personas.ts`
- `the-getaway/src/components/ui/DialogueOverlay.tsx`
...
### Step 16.8: Environmental Story Triggers & Ambient Feedback (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 8, 2025
...
2. Authored environment content tables (rumors, notes, signage, weather) plus selectors so ambient copy stays data-driven and consistent with the tone set in [[03 Lore/Plot Bible]].
...
- `the-getaway/src/game/interfaces/environment.ts`
- `the-getaway/src/content/environment/index.ts`
- `the-getaway/src/game/world/triggers/triggerRegistry.ts`
- `the-getaway/src/game/world/triggers/defaultTriggers.ts`
- `the-getaway/src/components/GameController.tsx`
- `the-getaway/src/store/selectors/worldSelectors.ts`
- `the-getaway/src/content/system/index.ts`
- `the-getaway/src/game/world/triggers/__tests__/defaultTriggers.test.ts`

#### Validation

- `yarn test --runTestsByPath src/game/world/triggers/__tests__/defaultTriggers.test.ts --runInBand --silent`

- Rumor copy, signage quips, and notes follow the straight-faced absurdity guidelines from [[03 Lore/Plot Bible]], keeping punchlines in the final line for easy future audits.
...
### Step 16.9: Route Ambient World Events Through George Assistant (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
- `the-getaway/src/game/interfaces/georgeAssistant.ts`
- `the-getaway/src/store/selectors/worldSelectors.ts`
- `the-getaway/src/game/systems/georgeAssistant.ts`
- `the-getaway/src/game/systems/__tests__/georgeAmbientTracker.test.ts`
- `the-getaway/src/components/ui/GeorgeAssistant.tsx`
- `the-getaway/src/content/ui/index.ts`
- `the-getaway/src/App.tsx`
...
### Step 25.4: Content & Systems Validation (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 6, 2025
...
- `the-getaway/src/content/items/index.ts`
- `the-getaway/src/content/backgrounds.ts`
...
### Step 24.2: Skill Tree System with Combat Branch (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 2, 2025
...
### Step 25.2: Durability & Encumbrance Mechanics (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 4, 2025
...
- Movement and attack pipelines honour encumbrance-derived AP multipliers; queued path traversal aborts when the player is immobile and logs the localized warning.- `src/store/playerSlice.ts`: Reducer helpers for equip/unequip, repairs, stack management, and encumbrance refresh.- `src/game/inventory/encumbrance.ts`: Encumbrance thresholds, penalty multipliers, and helper APIs.- `src/game/combat/combatSystem.ts`: Durability-aware damage flow, combat events, and encumbrance-aware AP costs.- `src/components/GameController.tsx`: Movement gating, logging hooks for encumbrance/durability, and event handling.- `src/__tests__/playerSlice.test.ts`: Reducer regression coverage for new helpers and encumbrance scenarios.- `src/__tests__/combat.test.ts`: Durability and encumbrance combat tests.#### Validation
...
### Step 11.5: Implement Downtown/Slums Overhaul (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
### Step 16.5: Author Storylet Library Framework (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
- `the-getaway/src/game/quests/storylets/storyletTypes.ts`
- `the-getaway/src/game/quests/storylets/storyletRegistry.ts`
- `the-getaway/src/game/quests/storylets/storyletEngine.ts`
- `the-getaway/src/store/storyletSlice.ts`
- `the-getaway/src/components/system/MissionProgressionManager.tsx`
- `the-getaway/src/components/GameController.tsx`
- `the-getaway/src/content/storylets/index.ts`
...
### Step 18.5: Centralize Depth Ordering and Camera PostFX Defaults (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
4. Authored [[03 Lore/Art Direction]], updated the architecture guide, and added Jest coverage for the new depth utilities.
...
- `the-getaway/src/game/utils/depth.ts`
- `the-getaway/src/game/utils/IsoObjectFactory.ts`
- `the-getaway/src/game/scenes/MainScene.ts`
- `the-getaway/src/game/settings/visualSettings.ts`
- `the-getaway/src/game/utils/__tests__/depth.test.ts`
- `[[03 Lore/Art Direction]]`
- `[[04 Engineering/Architecture]]`
...
6. Recorded the grid and parcel rules in `/[[04 Engineering/Architecture]]`.
...
### Step 19.5: Surveillance Camera System (Curfew Enforcement) (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 9, 2025
...
- `the-getaway/src/content/cameraConfigs.ts`
...
- `the-getaway/src/components/ui/MiniMap.tsx`
- `the-getaway/src/__tests__/surveillanceSlice.test.ts`

#### Validation

- `yarn test --runTestsByPath src/__tests__/surveillanceSlice.test.ts --watch=false`

### Step 19.55: Adaptive NPC FSM Behaviors (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
5. Refreshed combat/automation/perception tests, introduced focused FSM unit coverage, and documented the new AI pipeline in [[04 Engineering/Architecture]].
...
- `the-getaway/src/game/ai/fsm/types.ts`
- `the-getaway/src/game/ai/fsm/random.ts`
- `the-getaway/src/game/ai/fsm/controller.ts`
- `the-getaway/src/content/ai/guardArchetypes.ts`
- `the-getaway/src/game/combat/enemyAI.ts`
- `the-getaway/src/game/interfaces/types.ts`
- `the-getaway/src/store/worldSlice.ts`
- `the-getaway/src/components/GameController.tsx`
- `the-getaway/src/game/ai/fsm/__tests__/controller.test.ts`
- `the-getaway/src/__tests__/combat.test.ts`
- `the-getaway/src/__tests__/autoBattlePlanner.test.ts`
- `the-getaway/src/__tests__/perceptionManager.test.ts`
- `the-getaway/src/__tests__/perks.test.ts`
- `[[04 Engineering/Architecture]]`
...
### Step 19.6: Implement Witness Memory & Regional Heat (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
- `the-getaway/src/game/systems/suspicion/witnessMemory.ts`
- `the-getaway/src/game/systems/suspicion/observationBuilders.ts`
- `the-getaway/src/game/systems/suspicion/aggregation.ts`
- `the-getaway/src/store/suspicionSlice.ts`
- `the-getaway/src/game/scenes/MainScene.ts`
- `the-getaway/src/components/GameController.tsx`
- `the-getaway/src/game/systems/surveillance/cameraSystem.ts`
- `the-getaway/src/components/debug/SuspicionInspector.tsx`
...
### Step 22: Define Player Stats (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 3, 2025
...
### Step 22.1: Basic Character Creation Flow (UI Shell, Name, Visual Preset) (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 3, 2025
...
### Step 22.2: Attribute Allocation System (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 4, 2025
...
### Step 22.3: Background Selection with Starting Perks (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 4, 2025
...
### Step 23: Integrate Player Stats with Combat and Dialogue Systems (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 3, 2025
...
### Step 23.5: Wire Equipment Stats to Combat Formulas (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 3, 2025
...
### Step 24.1: XP and Leveling Foundation (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 1, 2025
...
### Step 24.3: Perk Selection System with Capstone Perks (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 3, 2025
...
### Step 24.5: Stamina System - Core Resource Pool (MVP) (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 5, 2025
...
- `src/components/ui/LevelUpPointAllocationPanel.tsx`
- `src/components/ui/CharacterCreationScreen.tsx`
- `src/content/ui/index.ts`
- `src/content/system/index.ts`
...
### Step 25.1: Inventory Data & Slot Framework (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 5, 2025
...
### Step 25.3: Inventory & Loadout UI Overhaul (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 6, 2025
...
- `the-getaway/src/components/ui/PlayerInventoryPanel.tsx`
- `the-getaway/src/store/playerSlice.ts`
- `the-getaway/src/__tests__/PlayerInventoryPanel.test.tsx`
...
### Step 35.2: Level Objective Progression Flow (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 8, 2025
...
- `the-getaway/src/content/missions.ts`
- `the-getaway/src/store/missionSlice.ts`
- `the-getaway/src/store/selectors/missionSelectors.ts`
- `the-getaway/src/components/ui/LevelIndicator.tsx`
- `the-getaway/src/components/system/MissionProgressionManager.tsx`
- `the-getaway/src/components/ui/MissionCompletionOverlay.tsx`
- `the-getaway/src/components/ui/GeorgeAssistant.tsx`
- `the-getaway/src/game/systems/georgeAssistant.ts`
- `the-getaway/src/__tests__/missionSelectors.test.ts`
- `the-getaway/src/__tests__/missionSlice.test.ts`
...
### Step 35.5: Implement George AI Assistant Overlay (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 7, 2025
...
- `the-getaway/src/game/interfaces/types.ts`
- `the-getaway/src/game/interfaces/player.ts`
- `the-getaway/src/store/playerSlice.ts`
- `the-getaway/src/store/selectors/playerSelectors.ts`
- `the-getaway/src/store/selectors/questSelectors.ts`
- `the-getaway/src/game/systems/georgeAssistant.ts`
- `the-getaway/src/content/assistants/george.ts`
- `the-getaway/src/components/ui/GeorgeAssistant.tsx`
- `the-getaway/src/App.tsx`
- `the-getaway/src/components/ui/LevelIndicator.tsx`
- `the-getaway/src/__tests__/georgeAssistant.test.ts`
...
### Step 29: Implement Faction Reputation System with Three Core Factions (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 9, 2025
...
-`the-getaway/src/game/systems/factions.ts`now owns faction metadata, standing localisation, automated rival penalties, and declarative action mappings for storyline beats.
-`the-getaway/src/store/playerSlice.ts`records faction changes, clamps background defaults, and exposes reducers so quests or scripted events can mutate reputation without duplicating logic.
-`the-getaway/src/components/ui/FactionReputationPanel.tsx`and`the-getaway/src/components/system/FactionReputationManager.tsx`connect the new selectors to HUD presentation and toast/log feedback.
- Dialogue and traversal gating respect faction requirements via`the-getaway/src/game/quests/dialogueSystem.ts`and`the-getaway/src/components/GameController.tsx`, reusing shared localisation from `content/system/ui`.

- `the-getaway/src/game/systems/factions.ts`
- `the-getaway/src/store/playerSlice.ts`
- `the-getaway/src/store/selectors/factionSelectors.ts`
- `the-getaway/src/components/ui/FactionReputationPanel.tsx`
- `the-getaway/src/components/system/FactionReputationManager.tsx`
- `the-getaway/src/components/GameController.tsx`
- `the-getaway/src/game/quests/dialogueSystem.ts`
- `the-getaway/src/__tests__/playerSlice.test.ts`
- `the-getaway/src/__tests__/dialogueSystem.test.ts`

#### Validation

- `yarn test --runTestsByPath src/__tests__/playerSlice.test.ts src/__tests__/dialogueSystem.test.ts`

### Step 25: Expand Inventory System with Equipment and Durability (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
-`the-getaway/src/store/playerSlice.ts`houses the expanded inventory state, helper reducers, durability checks, repair routing, and weight calculations shared across combat and movement.
-`the-getaway/src/game/inventory/inventorySystem.ts`and`the-getaway/src/game/combat/combatSystem.ts`generate hydrated item instances, apply durability modifiers, and trigger decay during attacks or mitigation.
-`the-getaway/src/components/ui/PlayerInventoryPanel.tsx`plus`the-getaway/src/components/ui/PlayerLoadoutPanel.tsx`render slot grids, durability bars, encumbrance banners, and hotbar controls with accessible labels.
-`the-getaway/src/content/items/index.ts`seeds durability defaults and cloning helpers so backgrounds, loot tables, and migration scripts share a single authoritative catalog.

- `the-getaway/src/store/playerSlice.ts`
- `the-getaway/src/game/inventory/inventorySystem.ts`
- `the-getaway/src/game/combat/combatSystem.ts`
- `the-getaway/src/components/ui/PlayerInventoryPanel.tsx`
- `the-getaway/src/components/ui/PlayerLoadoutPanel.tsx`
- `the-getaway/src/content/items/index.ts`
- `the-getaway/src/__tests__/playerSlice.test.ts`
- `the-getaway/src/__tests__/PlayerInventoryPanel.test.tsx`
- `the-getaway/src/__tests__/combat.test.ts`
...
### Step 25.5: Integrate Equipment Effects with Combat and Movement (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 10, 2025
...
-`the-getaway/src/store/playerSlice.ts`blocks secondary equips while a two-handed primary is active, auto-unequips conflicting slots, and preserves inventory consistency before refreshing encumbrance.
-`the-getaway/src/game/combat/combatSystem.ts`interprets trait tags to adjust damage, crit flows, armor mitigation, and noise events while still emitting durability telemetry.
-`the-getaway/src/content/items/index.ts`annotates baseline armours with AP penalties and heavy/medium/light tags while flagging the industrial crowbar as two-handed.
-`the-getaway/src/game/systems/equipmentTags.ts`centralises tag helpers so reducers and combat logic share trait detection.

- `the-getaway/src/store/playerSlice.ts`
- `the-getaway/src/game/combat/combatSystem.ts`
- `the-getaway/src/game/systems/equipmentTags.ts`
- `the-getaway/src/content/items/index.ts`
- `the-getaway/src/game/systems/equipmentEffects.ts`
- `the-getaway/src/__tests__/playerSlice.test.ts`
- `the-getaway/src/__tests__/combat.test.ts`
...
### Step 32.1: Implement Unit Test Suite (70%+ Code Coverage) (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 12, 2025
...
- `the-getaway/src/game/combat/__tests__/combatSystem.test.ts`
- `the-getaway/src/game/world/__tests__/pathfinding.test.ts`
- `the-getaway/src/game/inventory/__tests__/inventorySystem.test.ts`
- `the-getaway/src/game/systems/__tests__/progression.test.ts`
- `the-getaway/src/game/quests/__tests__/dialogueSystem.test.ts`
- `the-getaway/jest.config.js`
...
### Step 26: Advanced Combat Foundations (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 12, 2025
...
-`the-getaway/src/game/interfaces/types.ts`models cardinal facings, cover profiles, and new combat state fields on `Player`/`Enemy` entities.
-`the-getaway/src/game/combat/combatSystem.ts`normalises cover arguments, applies half/full mitigation, exports reaction queue helpers, and keeps attackers oriented via `applyCoverStateFromTile`/`applyMovementOrientation`.
-`the-getaway/src/game/combat/reactions.ts`provides the queue primitive consumed by combat.
-`the-getaway/src/game/combat/enemyAI.ts`now orients enemies after movement and passes map context into attacks so cover math engages.
-`the-getaway/src/game/world/grid.ts`exposes `setTileCoverProfile` for directional cover authoring.
-`the-getaway/src/game/scenes/MainScene.ts`renders a cover wedge overlay during path previews.
-`the-getaway/src/store/playerSlice.ts`updates facing when the player moves.

- `the-getaway/src/game/interfaces/types.ts`
- `the-getaway/src/game/interfaces/player.ts`
- `the-getaway/src/game/combat/combatSystem.ts`
- `the-getaway/src/game/combat/reactions.ts`
- `the-getaway/src/game/combat/enemyAI.ts`
- `the-getaway/src/game/world/grid.ts`
- `the-getaway/src/game/scenes/MainScene.ts`
- `the-getaway/src/store/playerSlice.ts`
- `the-getaway/src/game/combat/__tests__/combatSystem.test.ts`
- `the-getaway/src/game/combat/__tests__/reactions.test.ts`
...
### Step 16.6: Standardize Level → Mission → Quest Hierarchy & Resource Keys (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
- **Date:** October 15, 2025
...
- `the-getaway/src/game/narrative/structureTypes.ts`
- `the-getaway/src/content/missions.ts`
- `the-getaway/src/content/quests/builders.ts`
- `the-getaway/src/game/narrative/validateContent.ts`
- `the-getaway/src/content/locales/en/index.ts`
- `[[04 Engineering/Architecture]]`
...
### Step 35: Surface Level & Objective HUD (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
- Zone metadata lives in `getZoneMetadata` and is merged during `createCityArea` / interior creation so Phaser scenes and HUD consumers read a single enriched `MapArea`.
...
- `the-getaway/src/content/zones.ts`
- `the-getaway/src/game/world/worldMap.ts`
- `the-getaway/src/components/ui/LevelIndicator.tsx`
- `the-getaway/src/content/ui/index.ts`
- `the-getaway/src/content/missions.ts`
...
### Step 16.7: Prototype Narrative → Triple → Scene Pipeline (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
- The CLI stitches extraction + generation, emits JSON into `content/levels/{level}/missions/{mission}/generatedScenes`, and logs validation issues for missing assets or collisions.

- `the-getaway/src/game/narrative/tripleTypes.ts`
- `the-getaway/src/game/narrative/tripleExtraction.ts`
- `the-getaway/src/game/world/generation/relationRules.ts`
- `the-getaway/src/game/world/generation/worldGenerationPipeline.ts`
- `the-getaway/scripts/generate-scene-from-story.ts`
- `the-getaway/src/content/levels/level0/missions/level0-recover-cache/generatedScenes/scene-level0-recover-cache-ambush-route.json`
- `the-getaway/src/content/missions/level0-recover-cache/missionDefinition.ts`
- `the-getaway/src/content/scenes/generatedScenes.ts`
...
### Step 113: Unify George assistant events feed and activate Ask George input (Completed)
- **Phase:** Phase 9: Optional Expansions (POST-MVP)
...
-`the-getaway/src/components/ui/GeorgeAssistant.tsx`-`the-getaway/src/App.tsx`-`the-getaway/src/content/ui/index.ts`-`[[04 Engineering/Architecture]]`#### Validation
