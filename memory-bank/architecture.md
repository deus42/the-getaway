...
6. <code_location>the-getaway/src/game/visual/world/OcclusionReadabilityController.ts</code_location> applies visual-only readability compensation (building alpha fade + token/label emphasis) when entities overlap heavy massing bounds.
