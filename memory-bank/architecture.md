...
6. <code_location>the-getaway/src/components/ui/GeorgeAssistant.tsx</code_location> pipes tracker output into a dedicated Ambient Feed tab, highlights the dock when unseen events queue up, and promotes the newest summary into the collapsed ticker so world changes surface even with the console closed.
</technical_flow>
