...
- ☐ The Level 0 matte HUD still needs full compact-width coverage, while time-based perception/FSM intent and the React-owned simulation boundary remain gameplay risks (GET-183, GET-186, GET-188).
