...
- GET-205 is parked until the actual source-geometry Blender gate passes.
- Current accepted live runtime and uncommitted GET-205 trial are preserved during the Blender rebuild.
