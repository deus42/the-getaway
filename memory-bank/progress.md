...
<tasks>
1. Authored `environmentMatrix.ts` with canonical factor enums plus `resolveEnvironmentalFactors`/`combineSystemImpacts`, and added coverage guarding factor completeness and aggregation behaviour.
