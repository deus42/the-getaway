export default {
  ...
  collectCoverageFrom: [
    ...
    "!<rootDir>/src/game/visual/world/BuildingPainter.ts",
    "!<rootDir>/src/game/visual/world/EnvironmentComposer.ts",
    "!<rootDir>/src/game/visual/world/PropScatter.ts",
    "!<rootDir>/src/game/visual/world/TilePainter.ts",
