  ...
  return (
    ...
    >
      <div className="hud-menu-modal flex w-[min(520px,92%)] max-h-[90vh] flex-col overflow-y-auto rounded-[18px] border border-[rgba(148,163,184,0.25)] bg-[rgba(15,23,42,0.92)] px-[2.25rem] py-[2rem] text-[#f8fafc] shadow-[0_24px_50px_rgba(15,23,42,0.45)]">
        <div className="mb-[1.1rem] flex flex-col items-center text-center">
        ...
        {activeView === "landing" ? (
          ...
          <div
            ...
            className="hud-menu-section mt-[0.55rem] flex flex-col gap-[0.85rem] rounded-[14px] border border-[rgba(148,163,184,0.25)] bg-[rgba(15,23,42,0.6)] p-[0.9rem]"
          >
            <div className="hud-menu-section__header border-b border-[rgba(148,163,184,0.15)] pb-[0.45rem]">
        ...
        <div className="mt-[1.4rem] flex flex-wrap items-center justify-center gap-[0.65rem] text-center text-[0.75rem] uppercase tracking-[0.22em] text-[#64748b]">
