...
export const GAME_BIBLE_DECISION_COVERAGE: GameBibleDecisionCoverage = {
  ...
  ...cover('character.overview', ['GDR-PC-002']),
  ...
  ...cover('character.in-play', [
    'GDR-RPG-001', 'GDR-RPG-002', 'GDR-RPG-003', 'GDR-RPG-004',
    'GDR-RPG-005', 'GDR-RPG-006', 'GDR-RPG-007',
  ]),
  ...cover('condition.in-play', [
    'GDR-HLT-001', 'GDR-HLT-002', 'GDR-HLT-003', 'GDR-PAR-001', 'GDR-PAR-002',
    'GDR-PAR-003', 'GDR-PAR-004', 'GDR-PAR-005', 'GDR-PAR-006', 'GDR-PAR-007',
  ]),
  ...cover('condition.recovery', ['GDR-FAIL-001']),
  ...cover('time.in-play', [
  ...
  ...cover('hud.overview', ['GDR-UI-001', 'GDR-UI-002', 'GDR-UI-004']),
